...
async function fetchProductos() {
	...
	data.forEach((producto, index) => {
		...
		<div class="card mb-4 shadow-sm">
				...
				<div class="card-body">
					<img src=${producto.imagen} class="card-img-top" alt=${producto.nombre} Card image cap>
					<h1 class="card-title pricing-card-title precio">$ <span class="">${
						producto.precio
					}</span></h1>

					<a href="" class="btn btn-block btn-dark agregar-carrito" data-id=${producto.id}>Comprar</a>
				</div>
			</div>
		`
		if(index === 0){
